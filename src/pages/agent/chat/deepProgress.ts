...
export const AGENT_RUN_EVENT_MESSAGE_IDS: Record<string, string> = {
  'chat.status.preparing': 'pages.agent.chat.progress.preparing',
  'chat.skill.resolved': 'pages.agent.run.steps.event.chatSkillResolved',
  'chat.status.retrieving': 'pages.agent.chat.progress.retrieving',
  'chat.retrieval.started': 'pages.agent.run.steps.event.chatRetrievalStarted',
  'chat.retrieval.completed': 'pages.agent.run.steps.event.chatRetrievalCompleted',
  'chat.context.assembled': 'pages.agent.run.steps.event.chatContextAssembled',
  'chat.request.ready': 'pages.agent.run.steps.event.chatRequestReady',
  'chat.status.generating': 'pages.agent.chat.progress.generating',
  'chat.tool.planned': 'pages.agent.run.steps.event.chatToolPlanned',
  'chat.tool.started': 'pages.agent.run.steps.event.chatToolStarted',
  'chat.tool.completed': 'pages.agent.run.steps.event.chatToolCompleted',
  'chat.tool.result.validated': 'pages.agent.run.steps.event.chatToolResultValidated',
  'chat.waiting.user_input': 'pages.agent.run.steps.event.chatWaitingUserInput',
  'chat.waiting.user_approval': 'pages.agent.run.steps.event.chatWaitingUserApproval',
  'chat.model.retrying': 'pages.agent.run.steps.event.chatModelRetrying',
  'chat.answer.grounded': 'pages.agent.run.steps.event.chatAnswerGrounded',
  'chat.reply.persisted': 'pages.agent.run.steps.event.chatReplyPersisted',
  'chat.completed': 'pages.agent.run.steps.event.chatCompleted',
  'chat.cancelled': 'pages.agent.run.steps.event.chatCancelled',
  'chat.failed': 'pages.agent.run.steps.event.chatFailed',
