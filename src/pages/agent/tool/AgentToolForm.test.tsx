...
jest.mock('@/components/JsonDisplay', () => ({content}: any) => <pre data-testid="schema-preview">{content}</pre>)
...
describe('AgentToolForm', () => {
  ...
  it('switches between schema editing and structured preview', () => {
    ...
    expect(Form.useWatch).toHaveBeenCalledWith('mcpInputSchema', expect.objectContaining({preserve: true}))
