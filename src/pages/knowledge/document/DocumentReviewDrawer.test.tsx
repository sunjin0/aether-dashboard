...
jest.mock('@/services/knowledge/DocumentController', () => ({
  getDocumentVersions: jest.fn().mockResolvedValue({ data: [{ id: 'version-1', versionNo: 1, reviewStatus: 'AI_REVIEWED' }] }),
}))
...
describe('DocumentReviewDrawer', () => {
  it('renders the AI review workspace inside a drawer', async () => {
    render(<DocumentReviewDrawer documentId="document-1" open onClose={jest.fn()} onSuccess={jest.fn()} />)
