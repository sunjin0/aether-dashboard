...
const SandboxAdminPage: React.FC = () => {
  ...
  const publish = async () => {
    ...
    const configSnapshot = JSON.stringify({ ...advanced, runtime: values.runtime, network: values.network, scriptSlot: values.scriptSlot, timeoutSeconds: values.timeoutSeconds, maxOutputFiles: values.maxOutputFiles, maxOutputBytes: values.maxOutputMegabytes * 1024 * 1024, outputFormats: values.outputFormats })
    Modal.confirm({
